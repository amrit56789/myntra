     ...
     return (
          <div className="w-3/4 mx-auto mb-12 flex justify-between" >
               <div className='first-block w-3/5 flex justify-start flex-column'>
                    ...
                    <div className='border p-4 flex rounded-lg flex-column justify-between mt-4'>
                         ...
                         <div className='text-xs rounded leading-7 mt-2 text-justify'>
                    ...
                    <div className='bag-items mt-4'>
                         {bag.length > 0 ? bag.map((product, index) => (
                              <div key={index} className='border rounded-lg p-4 flex flex-col md:flex-row justify-between items-center mb-4'>
