...
export default function FooterProductList() {
  ...
  return (
    <div className="mt-8">
      ...
      <p className="text-sm text-zinc-500 tracking-wider font-light p-1 leading-relaxed text-justify">
      ...
      <div className='forth-footer  text-center leading-7 flex justify-between mt-8 text-zinc-400 mb-4'>
